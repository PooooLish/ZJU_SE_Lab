...
(
    ...
    test_time         varchar(128) not null,
...
insert into course(course_id,course_name,credit,course_department,category,schedule,location,semester,
                        max_students, num_students, test_time, grade_cal, target, description)
VALUES ('0', 'English', '2', 'English Department', 'Language', 'TBD', 'West4-3', 'Summer', '120', '0', 'TBD', 'TBD', 'Junior', 'TBD');
...
insert into student(school_id, college, class, major, duration, schooling_type, admission_time, except_graduation,
